...
const products = [
  { name:"Balcony Size", price:2490, old:2929, save:439, dim:"200×200 cm", desc:"Perfect for small balconies and compact spaces", fits:["Lounge chair","Small coffee table","Side plants"], pct:"Save 15%", image:"/images/balcony-size.png" },
  { name:"Dining Size", price:3290, old:3870, save:580, dim:"250×300 cm", desc:"Fits a 4-6 person outdoor dining room for family meals", fits:["4-6 person dining table","A shelf","Side wall bench"], pct:"Save 15%", image:"/images/dining-size.png" },
  { name:"Family Size", price:3990, old:4694, save:704, dim:"300×400 cm", desc:"The outdoor living room for the whole family", fits:["Corner L-shaped sofa","Coffee table","Bookcase / cabinet"], pct:"Save 15%", image:"/images/family-size.png" },
  { name:"Lounge Size", price:4990, old:5870, save:880, dim:"400×500 cm", desc:"Premium full-size relaxation and entertainment space", fits:["Lounge set","Sunbed(s)","Outdoor kitchen area"], pct:"Save 15%", image:"/images/lounge-size.png" },
];
